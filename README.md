# `gcr.io/paketo-buildpacks/oracle-jdk`
The Paketo Oracle JDK Buildpack is a Cloud Native Buildpack that provides the Oracle JDK implementations of JREs and JDKs.
...
[bpv]: https://github.com/paketo-buildpacks/oracle-jdk/releases
